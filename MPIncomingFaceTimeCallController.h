...
@class CNFConferenceController, CNFDisplayController, NSDictionary, NSString, NSURL, TPBottomLockBar, UIView;

@interface MPIncomingFaceTimeCallController : SBUISlidingFullscreenAlertController <ABPredicateDelegate>
{
